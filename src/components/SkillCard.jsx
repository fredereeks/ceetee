...
function SkillCard({image, title, text, direction}) {
  return (
    <aside className={`group py-8 px-4 flex flex-col items-stretch gap-3 md:gap-5 ${direction ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
        <div className="relative border-2 border-slate-600 flex-1 mx-auto flex h-full py-4 flex-shrink-0 group-hover:shad bg-white rounded-md overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center gap-2 py-4 flex-shrink-0 border-2 border-slate-600 ">
