                    ...
                    <label htmlFor='inquiry' className="scale-0 peer-checked:scale-100 duration-100 z-[1000] fixed bg-gray-800/50 w-screen h-screen p-10 grid place-items-center top-0 left-0">
                      <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col bg-gray-100 rounded-md p-4 min-w-[300px] max-w-[35rem]">
                        ...
                        <div className="flex flex-col gap-2 p-5">
                          ...
                          <input type="text" disabled required value={state?.title} className={`outline-none placeholder-opacity-70 text-slate-500 text-sm sm:text-md bg-transparent border-[1px] border-zinc-200 rounded-[.25rem] py-2 px-4`} name="course" placeholder={state?.title} />
                          <div className="flex w-full gap-1 py-2 border-[1px] border-zinc-200 bg-transparent rounded-md overflow-hidden">
                            <PhoneInput
                              ...
                              flags={flags}
                              limitMaxLength={8}
                              className='w-full outline-none placeholder-opacity-70 text-zinc-500 focus:border.pri bg-transparent border-[1px] border-zinc-200 rounded-md px-4 flex-1'
                            />
                          </div>
