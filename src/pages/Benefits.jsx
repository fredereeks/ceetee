            ...
            <section className="py-20 bg-white">
                <div className="container max-w-[960px] mx-auto flex flex-col md:flex-row md:justify-center md:items-center gap-2 px-4">
                    <div className="flex flex-1 px-3 py-4 flex-col gap-3">
                        ...
                        <h3 className="text-blue-700 font-bold text-2xl md:text-3xl">What you get with CTTI </h3>
                        <div className="flex flex-col gap-4 pt-3">
                            ...
                            <div className="flex gap-2 items-center">
                                <span className="shad h-[30px] w-[30px] md:w-[45px] md:h-[45px] flex-shrink-0 rounded-full grid place-items-center bg-white">
                                    <IoMdBriefcase className="text-lg md:text-2xl text-[#fac451]"/>
                                </span>
                                <p className="thin-text text-sm md:text-base leading-tight">We are trusted and <Link className="font-medium text-blue-700" to="/partners">partners</Link> with a wide range of world class Universities and similar legitimate online platforms </p>
                            </div>
                            <div className="flex gap-2 items-center">
                                <span className="shad h-[30px] w-[30px] md:w-[45px] md:h-[45px] flex-shrink-0 rounded-full grid place-items-center bg-white">
                    ...
                    <div className="relative flex flex-1 flex-col py-2 overflow-hidden">
                        <img src={ctti_digital_marketing} alt="CTTI Digital Marketing" className="h-[250px] md:h-[350px] w-[250px] md:w-[350px] rounded-md object-cover ml-auto mr-auto md:mr-5 shad" />
                        <img src={ctti_biz_skill} alt="CTTI Digital Marketing" className="absolute h-[80px] md:h-[100px] w-[80px] md:w-[100px] rounded-md border-3 border-white object-cover bottom-5 left-4 shad shadow-white " />
                    </div>
                </div>
            </section>
                ...
                <div className="container max-w-[960px] mx-auto flex flex-col md:flex-row md:justify-center md:items-center gap-2 px-4">
                    ...
                    <div className="sm:flex-1 grid grid-cols-2 justify-center gap-2 bg-white px-4 py-5 md:p-6 shad shadow-gray-500 overflow-hidden rounded-sm w-max">
                        <aside className="max-w-[150px] sm:max-w-full sm:w-full flex flex-col gap-3">
                            <img src={niit_web_students} alt="ctti web dev student" className="h-[150px] md:h-[200px] object-cover rounded-md" />
                            <div className="flex py-2 flex-col">
                                <h4 className="text-indigo-500 font-medium text-lg md:text-xl">Andrew Sunday</h4>
                                <p className="text-xs md:text-sm thin-text">Student, Web Development</p>
                            </div>
                        </aside>
                        <aside className="max-w-[150px] sm:max-w-full sm:w-full flex flex-col gap-3">
                            <div className="h-[150px] md:h-[200px] relative">
                                <img src={ctti_career} alt="ctti web dev student" className="h-[150px] md:h-[200px] object-cover rounded-md" />
                    ...
                    <div className="md:flex-1 grid grid-cols-1 sm:grid-cols-2 justify-center gap-2 bg-white px-4 py-5 md:p-6 shad shadow-gray-500 overflow-hidden rounded-sm w-max mx-auto sm:mx-0">
                        <aside className="grid grid-cols-1 sm:grid-cols-2 gap-1">
                            <div className="flex gap-2 sm:pr-1 md:pr-0 sm:gap-0 items-center sm:items-start sm:flex-col">
                                <img src={ctti_cyber} alt="ctti web dev student" className="h-[50px] sm:h-[150px] md:h-[100px] w-[50px] sm:w-full md:w-[100px] object-cover rounded-md" />
                                <div className="flex py-2 flex-col">
                                    <h4 className="text-indigo-500 font-medium text-md md:text-base">Peter Benedict</h4>
                                    <p className="text-xs md:text-sm thin-text">Instructor, Cyber Security</p>
                                </div>
                            </div>
                            <div className="flex gap-2 sm:pr-1 md:pr-0 sm:gap-0 items-center sm:items-start sm:flex-col">
                                <img src={ctti_database} alt="ctti web dev student" className="h-[50px] sm:h-[150px] md:h-[100px] w-[50px] sm:w-full md:w-[100px] object-cover rounded-md" />
                                <div className="flex py-2 flex-col">
                                    <h4 className="text-indigo-500 font-medium text-md md:text-base">Idiongomfon Imoh</h4>
                        ...
                        <aside className="flex flex-col gap-3">
                            <div className="h-[150px] md:h-[200px] relative">
                                <img src={ctti_datascience} alt="ctti web dev student" className="h-[150px] md:h-[200px] object-cover rounded-md" />
