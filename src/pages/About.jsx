  ...
  return (
    <main className="bg-slate-50 py-20">
      <div className="container pt-10 mx-auto max-w-960 flex flex-col">
        ...
        <div className="flex flex-col gap-2">
          <aside className={`py-2 flex flex-col gap-3 md:gap-5 md:items-center md:flex-row`}>
              ...
              <div className="flex flex-col gap-2 px-4 py-2 md:p-4 flex-1 md:flex-2">
                  <h4 className={`text-md md:text-lg text-transparent font-bold text-cyan-500 uppercase`}>Our Mission</h4>
          ...
          <aside className={`py-2 flex flex-col gap-3 md:gap-5 md:items-center md:flex-row-reverse`}>
              ...
              <div className="flex flex-col gap-2 px-4 py-2 md:p-4 flex-1 md:flex-2">
                  <h4 className={`text-md md:text-lg text-transparent font-bold text-indigo-600 uppercase`}>Our Approach</h4>
        ...
        <div className="container justify-center items-stretch grid diff sm:grid-cols-2 mx-auto py-10 gap-x-2 gap-y-4 sm:gap-y-8 sm:gap-x-6 max-w-[960px] py-10 px-2 sm:px-4">
