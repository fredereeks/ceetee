            ...
            <div className="relative flex items-center justify-center">
                <form action="" onSubmit={handleSubmit} ref={formRef} className="form max-w-[40rem] w-[15rem] relative mx-auto flex flex-col gap-3 ">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input onChange={handleChange} type="text" placeholder='Phone Number' name='phone' className="w-full outline-none placeholder-opacity-70 text-zinc-500 focus:border.pri bg-transparent border-[1px] border-zinc-200 rounded-md py-2 px-4" />
